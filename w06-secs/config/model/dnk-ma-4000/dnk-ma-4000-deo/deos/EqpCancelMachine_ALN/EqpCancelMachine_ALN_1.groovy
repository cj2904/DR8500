...
class EqpCancelMachine_ALN_1
{
    ...
    public void execute()
    {
        def startCommand = TscConfig.getStringProperty("CANCEL", "START")
        logger.info("Sending $startCommand to equipment")

        def request =  new S2F41HostCommandSend(new SecsAsciiItem("CANCEL"))
        ...
        {
            throw new Exception("Fail to cancel equipment process with error: " + reply.getHCAckMessage())
        }
