...
SET SYSTEM_PROPERTIES=-Dde.znt.util.PropertyHelper.fileName="%PAC_HOME%"\config\properties\application.properties -Dfile.encoding=UTF-8 -Duser.language=en -Duser.home="%PAC_WORKING_DIR%" -DAppDir="%PAC_HOME%" -Drv.encoding=ISO8859_1
