package WinApiEapRemoveAllDomainObjects
...
<b>Clear all Domain Objects in persistent</b>
''')
class WinApiEapRemoveAllDomainObjects_1
{
	...
	public void execute()
	{
		if(cMaterialManager.getCLotList(new LotFilterAll()).size()==0)
		{
			...
			logger.info("Remove winApiWipData domain object done.")
		}
	}
}