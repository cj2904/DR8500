...
set PATH=%PATH%;%LIBS%
SET SYSTEM_PROPERTIES=-Ddeo.path=%DEO_PATH% -Dlocalcontext=%TRIGGER_CONTEXT% -DPac.DefaultContext=%TRIGGER_DEFAULT_CONTEXT% -Dde.znt.util.PropertyHelper.fileName="%PAC_HOME%"\config\properties\application.properties -Dfile.encoding=UTF-8 -Duser.language=en -Duser.home="%PAC_WORKING_DIR%" -DAppDir="%PAC_HOME%" -Drv.encoding=ISO8859_1 
