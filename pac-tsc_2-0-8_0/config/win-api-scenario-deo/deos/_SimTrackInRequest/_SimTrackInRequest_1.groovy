...
class _SimTrackInRequest_1 {
    ...
    public void execute()
    {
        ...
        runtimeParameters.put("EventName", TscZWinApiScenario.EVENT_TRACK_IN)
        deoEventDispatcher.notifyEvent(TscZWinApiScenario.PROVIDER, TscZWinApiScenario.DEO_CATEGORY_EVENT, TscZWinApiScenario.EVENT_TRACK_IN, runtimeParameters)
    }
}