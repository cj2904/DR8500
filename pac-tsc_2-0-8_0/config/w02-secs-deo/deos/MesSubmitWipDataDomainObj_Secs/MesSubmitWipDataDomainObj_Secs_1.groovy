package MesSubmitWipDataDomainObj_Secs
...
@CompileStatic
@Deo(description='''
submit wip data using domain object for Secs eqp
''')
class MesSubmitWipDataDomainObj_Secs_1
{
    ...
    public void execute()
    {
        ...
        else
        {
            ...
            if(wipDataSet != null)
            {
                ...
                request.getInputData().setContainer(outboundLot)
