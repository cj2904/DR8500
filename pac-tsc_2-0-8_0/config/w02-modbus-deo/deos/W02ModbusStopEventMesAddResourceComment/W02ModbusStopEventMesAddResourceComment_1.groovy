package W02ModbusStopEventMesAddResourceComment
...
''')
class W02ModbusStopEventMesAddResourceComment_1 {
	...
	public void execute() {
		...
		if(eqLogicalId.length() > 0) {
			...
			def request = new SetResourceCommentRequest(eqLogicalId, "[$status] Event 'Stop' at equipment $eqLogicalId @ $eventTime")
