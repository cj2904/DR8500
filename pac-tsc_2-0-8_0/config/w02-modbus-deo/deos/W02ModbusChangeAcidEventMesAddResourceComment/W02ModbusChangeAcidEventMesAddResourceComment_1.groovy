package W02ModbusChangeAcidEventMesAddResourceComment
...
@CompileStatic
@Deo(description='''
modbus change acid event and message
''')
class W02ModbusChangeAcidEventMesAddResourceComment_1 {
	...
	public void execute() {
		...
		if(eqLogicalId.length() > 0) {
			...
			def request = new SetResourceCommentRequest(eqLogicalId, "[$status] Event 'Change Acid' at equipment $eqLogicalId @ $eventTime")
